...
class GetNumberOfProjectsByMenteeIdUseCase(
    ...
    suspend operator fun invoke(request: GetMenteeNameByIdRequest): Result<Int> {
    ...
    private suspend fun onGetProjectsNumberByMenteeIdSuccess(mentees: List<Mentee>, menteeId: String): Result<Int> {
